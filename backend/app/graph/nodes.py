...
def generate_rag_node(state: AgentState) -> dict:
    ...
    rag_prompt = ChatPromptTemplate.from_messages([
        ("system", """คุณเป็น Chat-AI ผู้ช่วยตอบคำถามเกี่ยวกับองค์กร
...
- **ห้าม** ขึ้นต้นคำตอบด้วยคำว่า "YES", "NO", "Based on", หรือทวนคำถาม ให้ตอบเนื้อหาทันที"""),
        ("human", """เอกสารอ้างอิง:
{context}
...
def generate_direct_node(state: AgentState) -> dict:
    ...
    direct_prompt = ChatPromptTemplate.from_messages([
        ("system", """คุณเป็น Chat-AI ผู้ช่วยในองค์กร
